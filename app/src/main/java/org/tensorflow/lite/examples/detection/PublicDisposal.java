...
public class PublicDisposal extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void sendAlert(){
        Call<ResponseBody> call = recycleItApi.addAlert("abdullah@gmail.com", latitude, longitude, "TBD",
                "Pakistan","Lahore", "PUB", items);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.addMarker(new MarkerOptions().position(currentLocation).title("Reported location"));
